...
- **20260505-07-normalized-activity-timeline.md**: Breaking execution plan for deleting raw transport from core, replacing it with typed timeline facts plus reducers/projections, and making chat a pure projection.
