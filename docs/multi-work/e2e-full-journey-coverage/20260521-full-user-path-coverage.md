...
| `kanban` | 创建看板、进入看板、删除看板 | Kanban tab, CLI `board *` | `CRADLE-KANBAN-002..003`, `CRADLE-KANBAN-008`, `apps/server/tests/kanban.test.ts` | CLI board generated output 合同 | API/CLI integration | P0/P1 | Low |
