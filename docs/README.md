...
- **ROADMAP-agent-experience.md**: Product-facing roadmap for agent experience evolution.
...
- **exec-plans/**: Living execution plans that guide complex implementation work.
