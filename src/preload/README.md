...
- **index.d.ts**: Global window type declarations for preload-exposed APIs.
- **index.ts**: Runtime preload bridge exposing Electron and IPC devtool APIs to renderers.
