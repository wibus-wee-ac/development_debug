// Input: Electron safeStorage
// Output: encryptSecret and decryptSecret helpers for persisted credentials
// Position: Platform storage adapter for OS-backed secret encryption in the main process
