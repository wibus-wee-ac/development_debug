// Input: Electron app, Drizzle DB tables, ACP registry/installer/connection/process helpers
// Output: AcpService IPC adapter for ACP registry, install/uninstall, runtime sessions, audit, and metrics
