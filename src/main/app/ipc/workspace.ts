// Input: Node fs/path helpers, Electron dialog/shell, fast-glob/ignore, workspace DB access
// Output: WorkspaceService IPC adapter for workspace CRUD plus guarded file read/write helpers
// Position: App-level IPC surface for workspace lifecycle and filesystem access
