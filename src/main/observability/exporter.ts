...
// Position: observability namespace exporter used by devtool IPC methods

import { backendTimelineEvents } from '../db/schema'
...
export function exportObservabilityBundle(
  ...
  deps: { db: DrizzleDb, store: ObservabilityStore },
): ObservabilityBundle {
