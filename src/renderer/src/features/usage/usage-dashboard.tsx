// Input: ipc.usage.getDailyUsage, ipc.usage.getUsageSummary, ipc.usage.getUsageStats, ipc.usage.getCostSummary, ipc.usage.getDailyCost
...
export function UsageDashboard() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      ipc?.usage.getCostSummary().catch(() => undefined),
      ipc?.usage.getDailyCost().catch(() => undefined),
    ]).then(([d, s, st, costData, dailyCostData]) => {
      if (d) {
