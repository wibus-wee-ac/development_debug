...
/**
 * Normalize underscore emphasis to asterisk emphasis before handing content to
 * the Markdown parser. This avoids Slack/user-id-like underscore runs being
 * confused with emphasis while preserving code spans verbatim.
 */
