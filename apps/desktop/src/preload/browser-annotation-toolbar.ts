...
export const BROWSER_ANNOTATION_TOOLBAR_CSS = `
  ...
  #cradle-browser-comment-root [data-cradle-browser-comment-toolbar][data-send-visible="true"] {
    width: 337px;
  }
  ...
  #cradle-browser-comment-root [data-cradle-browser-comment-toolbar][data-send-visible="true"] [data-cradle-browser-comment-toolbar-container][data-expanded="true"] {
    width: 337px;
  }
  ...
  #cradle-browser-comment-root [data-cradle-browser-comment-toolbar-button][data-active="true"] {
    color: var(--cradle-browser-comment-accent);
    background: color-mix(in srgb, var(--cradle-browser-comment-accent) 25%, transparent);
  }
...
const ICONS: Record<BrowserAnnotationToolbarIcon, string> = {
  ...
  send: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M9.875 14.125L12.3506 19.6951C12.7184 20.5227 13.9091 20.4741 14.2083 19.6193L18.8139 6.46032C19.0907 5.6695 18.3305 4.90933 17.5397 5.18611L4.38072 9.79174C3.52589 10.0909 3.47731 11.2816 4.30494 11.6494L9.875 14.125ZM9.875 14.125L13.375 10.625" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
...
export function renderBrowserAnnotationToolbar(input: BrowserAnnotationToolbarInput): HTMLDivElement {
  ...
  toolbar.setAttribute('data-send-visible', String(input.sendVisible))
  if (input.position) {
