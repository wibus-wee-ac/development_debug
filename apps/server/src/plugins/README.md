...
- **loader.test.ts**：覆盖 server plugin activation 后由 `deactivateAllPlugins()` 清理 owner-scoped registrations 和 capability records，也覆盖 host activation hot disable / re-enable。
