...
- `codex/`: Codex app-server provider package using metadata, input, event-to-chunk, stream handler/diagnostics, UI slot, native/transcript projector, tool envelope, app-server bridge/client, and test modules.
