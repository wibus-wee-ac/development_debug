...
Codex profile config includes `titleModel`, which lets the Codex runtime provider choose a separate model for background session title generation while keeping the main chat model unchanged.
