...
- `service.ts`: Snapshot validation, source persistence, direct onboarding source refresh, runtime target projection, secret upsert, missing-record handling, runtime preference preservation, and view serialization.
