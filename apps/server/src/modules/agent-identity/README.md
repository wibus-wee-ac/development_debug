...
- **service.ts**: Agent CRUD semantics, local Claude/Codex import orchestration, avatar URL policy, runtime/profile validation, provider-target enabled normalization, and constraint mapping.
