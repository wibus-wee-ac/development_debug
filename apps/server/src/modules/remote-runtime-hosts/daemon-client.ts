...
export type RemoteRuntimeHostConnectionState =
  | 'idle'
  | 'connecting'
  | 'connected'
  | 'disconnected'
...
export interface RemoteAgentDaemonClient {
  readonly state: RemoteRuntimeHostConnectionState
