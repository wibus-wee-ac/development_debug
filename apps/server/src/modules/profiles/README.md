...
- `profiles.service.ts` — coordinates saved profile semantics, preserves profile config fields, stores profile-owned models.dev mappings, and handles session cleanup.
