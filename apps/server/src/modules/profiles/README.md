...
- `profiles.service.ts` — coordinates manual profile CRUD, stores profile-owned models.dev mappings, validates provider-kind stability for updates, and handles session cleanup.
