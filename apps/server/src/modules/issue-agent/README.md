...
- `service.ts`: delegation semantics, agent identity resolution, issue prompts with stable issue IDs, and chat-runtime completion subscription for agent run status.
