 ...
 * Position: Providers module owns the canonical model capability surface consumed by runtime selection UI.
 */

import type { ModelCapabilities, ModelDescriptor, ProviderKind } from './types'
