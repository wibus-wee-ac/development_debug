...
- `provider-base.ts` — shared Zod-backed config parsing and API-key helpers, including Codex app-server permission defaults and Claude Agent SDK-owned alias configuration from effective runtime `config.claudeAgent`.
