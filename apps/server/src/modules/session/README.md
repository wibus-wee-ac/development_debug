...
- **model.ts**: Session HTTP params/body/response schemas, including side chat parent/source response fields, the list/get `status` projection, and provider/model patch fields.
