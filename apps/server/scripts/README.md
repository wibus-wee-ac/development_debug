...
- `rebuild-electron-runtime.mjs`: rebuilds the server desktop runtime native dependencies in `dist/desktop-runtime/node_modules` against the Electron Node ABI used by Cradle desktop.
