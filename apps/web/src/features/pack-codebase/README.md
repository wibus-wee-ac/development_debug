...
- **pack-codebase-dialog.tsx**: Full-featured dialog with format selector, compression toggle, accessible scope path input, pattern filters, clipboard copy action, and first-render performance completion mark for the lazy dialog surface.
