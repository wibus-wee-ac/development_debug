...
export function CredentialSetupDialog() {
  ...
  function handleConfigurePreset() {
    ...
    toastManager.add({
      type: 'success',
      title: 'Opening provider settings',
  ...
  function handleUseCcSwitch() {
    ...
    toastManager.add({
      type: 'success',
      title: 'CC-Switch connected',
      description: 'Your existing providers are ready to use.',
    })
  }
  ...
  const rows: Row[] = [
    ...(ccSwitchDetected
      ? [{
          ...
          name: 'CC-Switch',
          description: 'Use your existing providers in CC-Switch — no import needed.',
          ready: true,
