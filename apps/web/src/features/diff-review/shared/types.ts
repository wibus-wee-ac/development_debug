import type {
  GetWorkspacesByIdDiffReviewsResponse,
  PostWorkspacesByIdDiffReviewsLocalWorkingTreeResponse,
} from '~/api-gen/types.gen'

/** A single Cradle diff review, regardless of how it was sourced. */
export type CradleDiffReview
  = | PostWorkspacesByIdDiffReviewsLocalWorkingTreeResponse
    | GetWorkspacesByIdDiffReviewsResponse[number]
...
/** Runtime that can produce a guided review. */
