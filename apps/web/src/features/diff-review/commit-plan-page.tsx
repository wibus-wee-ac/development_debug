...
export function CommitPlanPage({ workspaceId, repositoryPath, reviewId }: CommitPlanPageProps) {
  ...
  const showPlanningStatus = Boolean(latestCommitPlanningFix) && (commitPlanningActive || latestCommitPlanningFix?.status === 'failed')
    ...
    return (
      <div className="mt-4">
        ...
        <div className="mt-2 flex gap-2">
          ...
          >
            {updating ? <Loader2Icon className="size-3.5 animate-spin" /> : <CheckIcon className="size-3.5" />}
            Save
          </Button>
            ...
            ? (
                <div>
                  ...
                  <div className="mt-2 flex gap-2">
                    ...
                    >
                      {updating ? <Loader2Icon className="size-3 animate-spin" /> : <CheckIcon className="size-3" />}
                      Save
                    </Button>
    ...
    return (
      <div className="mt-8 flex items-center gap-2">
        <Button
          ...
          disabled={applying}
        >
          {applying ? <Loader2Icon className="size-4 animate-spin" /> : <GitCommitIcon className="size-4" />}
...
function RegenerateDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        {busy ? <Loader2Icon className="size-3.5 animate-spin" /> : <RotateCcwIcon className="size-3.5" />}
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <Button
          ...
          disabled={disabled}
        >
          {busy ? <Loader2Icon className="size-4 animate-spin" /> : <RotateCcwIcon className="size-4" />}
