...
- **browser-panel.test.tsx**: Regression tests for BrowserPanel shell render boundaries around workspace diff scroll commands and cross-session browser tab source markers.
