...
- **changes-panel.test.ts**: Unit coverage for Changes panel file-section grouping order, tree event metadata resolution, and Tree view double-click diff navigation with query/provider scaffolding for shared workspace file menu dependencies.
