...
This feature exposes unified Agent Profile lists and Agent entity CRUD to launchers and settings.
Provider execution and credentials remain in the Electron main process.

## Files

- **use-agent-profiles.ts**: `useAgentProfiles` hook — queries unified Agent Runtime profiles (Providers)
