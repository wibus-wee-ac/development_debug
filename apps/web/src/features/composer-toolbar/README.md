...
- **composer-toolbar.tsx**: Root toolbar component that chooses runtime-specific selectors from `useComposerState`; chat sessions show the bound runtime as a read-only control instead of hiding runtime context.
