...
- **external-provider-record-detail-panel.tsx**: External provider record 详情面板，保持 source-owned endpoint / credential / metadata 只读，同时通过 provider-target API 编辑 Cradle-owned model visibility、custom models 与 models.dev mapping
