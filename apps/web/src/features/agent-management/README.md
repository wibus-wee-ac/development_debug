...
- **agent-detail.tsx**: Agent 详情页，提供内联编辑 identity、provider/model/thinking 统一选择器、system prompt 与 agent-private Skills 管理，并确保 provider 切换时默认模型与 thinking 能力会同步到 state
