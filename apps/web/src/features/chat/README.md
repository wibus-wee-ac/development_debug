...
- **composer-attachment-state.ts**: Shared headless attachment controller; chat owns browser file conversion, pasted-file handling, model attachment gating, and model-switch cleanup for chat, new-chat, and workspace launcher composers
