...
- **context-items.ts**: Typed semantic context item, reference, envelope, freshness, sensitivity, and token-estimation contracts for the new Jarvis context engine
