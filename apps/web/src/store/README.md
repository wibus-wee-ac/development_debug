...
- **chat.ts**: Chat streaming state — stores per-session UI messages, session-level local driver metadata, generation flags, errors, and reconciles equivalent server snapshots without changing message references
