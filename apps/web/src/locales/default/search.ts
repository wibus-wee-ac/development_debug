export default {
  ...
  'mode.line.description': 'Go to a line in the active editor',
  'mode.line.label': 'Go to Line',
  'mode.line.placeholder': ': Go to line',
  'mode.quickOpen.description': 'Open files in the active workspace',
  'mode.quickOpen.label': 'Go to File',
  'mode.quickOpen.placeholder': 'Search files in the active workspace...',
  'mode.symbol.description': 'Find a symbol in the active file',
  'mode.symbol.label': 'Go to Symbol',
  'mode.symbol.placeholder': '@ Search symbols in file',
  'mode.workspaceSymbol.description': 'Find a symbol in the workspace',
  'mode.workspaceSymbol.label': 'Workspace Symbol',
  'mode.workspaceSymbol.placeholder': '# Search workspace symbols',
