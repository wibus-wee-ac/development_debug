...
--> statement-breakpoint
CREATE UNIQUE INDEX `chat_runtime_events_stream_seq_unique` ON `chat_runtime_events` (`stream_id`,`seq`);--> statement-breakpoint
CREATE INDEX `chat_runtime_events_stream_id_idx` ON `chat_runtime_events` (`stream_id`);--> statement-breakpoint
CREATE INDEX `chat_runtime_events_run_id_idx` ON `chat_runtime_events` (`run_id`);--> statement-breakpoint
CREATE INDEX `chat_runtime_events_message_id_idx` ON `chat_runtime_events` (`message_id`);--> statement-breakpoint
CREATE INDEX `chat_runtime_events_queue_item_id_idx` ON `chat_runtime_events` (`queue_item_id`);--> statement-breakpoint
CREATE INDEX `chat_runtime_events_type_idx` ON `chat_runtime_events` (`type`);--> statement-breakpoint
CREATE INDEX `chat_runtime_events_occurred_at_idx` ON `chat_runtime_events` (`occurred_at`);--> statement-breakpoint
