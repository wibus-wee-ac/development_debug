// Input: DOM Event types
// Output: Screen coordinate helpers for drag tear-off detection
// Position: Utility module extracted from tab-bar to satisfy react-refresh/only-export-components
